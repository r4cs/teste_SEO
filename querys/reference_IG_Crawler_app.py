...
class App:
    def __init__(self, username='rac_hell', password='Hehehe01', target_username='pelota_quadrada',
                 path='/Users/rac_hell/Instagram Babs'): #Change this to your Instagram details and desired images path
